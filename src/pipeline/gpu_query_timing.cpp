...
bool GpuQueryTiming::init(VkDevice device, VkQueue queue, VkPhysicalDevice phys_device) {
    ...
    try {
        ...
        fprintf(stderr, "[GpuQueryTiming] Exception during init\n");
        return false;
    }
}
...
bool GpuQueryTiming::record_timestamp(VkCommandBuffer cmd, const char* label) {
    ...
    try {
        ...
        fprintf(stderr, "[GpuQueryTiming] Exception during record_timestamp\n");
        return false;
    }
}
...
bool GpuQueryTiming::retrieve_results(QueryResult* out_result) {
    ...
    try {
        ...
        fprintf(stderr, "[GpuQueryTiming] Exception during retrieve_results\n");
        return false;
    }
}
...
void GpuQueryTiming::shutdown() {
    try {
        ...
        fprintf(stderr, "[GpuQueryTiming] Exception during shutdown\n");
    }
}

...
- **I2 + I3** (dual-GPU sync) en yuksek efor gerektiren madde; Pipeline::Impl
  refactoring'de kullanilan asamali yaklasim (karakterizasyon testi +
  baseline_metrics.txt karsilastirmasi) burada da uygulanmali — AMD
  donaniminda gorsel/otomatik regresyon testi olmadan bu alanda degisiklik
  yapmak riskli.
